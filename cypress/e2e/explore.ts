...
describe('Explore Page', () => {
  ...
  it('should filter by price', () => {
    ...
    cy.getByDataCy('game-card').first().within(() => {
      cy.shouldBeLessThen(500)
    })
  })

  it('should filter by platfrom and genre', () => {
